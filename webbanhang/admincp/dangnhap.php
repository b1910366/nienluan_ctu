...
if(isset($_POST['dangnhap'])) {
    ...
    if ($count > 0) {
        $_SESSION['dangnhap'] = $account;
        echo 
        '<div class="alert alert-success text-center">
            <strong>Thành Công!</strong> Bạn vừa tạo đăng nhập thành công.
        </div>';
        header("Location: index.php");
    } else {  
        echo '
        <div class="alert alert-danger">
        <strong>Thất bại!</strong> Kiểm tra lại Tên người dùng hoặc Mật Khẩu!
        </div>'  ;
                    ...
                    <section class="w-100 p-4 d-flex justify-content-center pb-4">
                        <form style="width: 35rem;" action="" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" autocomplete="off" id="form2Example1" class="form-control" name="username">
                            ...
                            <!-- Submit button -->
                            <button type="submit" class="btn btn-primary btn-block mb-4" name="dangnhap">Đăng nhập</button>
